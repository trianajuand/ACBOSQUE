...
## Titulo
Colocacion de orden Limit.

## Descripcion
Como inversionista autenticado
Quiero colocar una orden Limit con precio limite
Para operar solo bajo el precio definido.

## Contexto
HU-18 usa el flujo parametrizado de ordenes con tipoOrden=LIMIT.
