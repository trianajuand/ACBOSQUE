...
## Titulo
Generacion de reporte personal de actividad.

## Descripcion
Como inversionista
Quiero generar reporte PDF o Excel de un periodo
Para revisar ordenes, ganancias, perdidas y comisiones.

## Contexto
HU-27 es Could Have y no aparece implementada en endpoints actuales.
...
## Backend
Pendiente servicio de reporte dentro de Ordenes.
...
## API / Endpoints
- Pendiente: GET /api/reportes/actividad
