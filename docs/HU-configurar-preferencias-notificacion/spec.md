...
## Contexto
La preferencia se gestiona desde configuración en Angular y se persiste en columnas del usuario. Cubre HU-8.
...
## Base de datos
Tabla `usuario`: `notificacion_email`, `notificacion_sms`, `notificacion_whatsapp`, `tipos_notificacion`.
