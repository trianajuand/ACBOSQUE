...
## Titulo
Colocacion de orden Take Profit.

## Descripcion
Como inversionista autenticado
Quiero colocar una orden Take Profit
Para tomar ganancias al llegar al precio objetivo.

## Contexto
HU-20 usa el flujo parametrizado de ordenes con tipoOrden=TAKE_PROFIT.
...
## Backend
Implementado dentro de OrdenService.crearOrden usando precioLimite.
